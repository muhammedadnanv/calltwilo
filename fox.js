(function() {
    ...
    const ws = new WebSocket('wss://media.agent4.ai/chat/YTE3MDFmYTYtYWEzMy0xMWVlLThlOWItMGE1OGE5ZmVhYzAy');
    //const ws = new WebSocket('wss://centipede.ngrok.app/chat/YTE3MDFmYTYtYWEzMy0xMWVlLThlOWItMGE1OGE5ZmVhYzAy/');
